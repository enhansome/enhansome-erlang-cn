...
* [relx](https://github.com/erlware/relx) ⭐ 694 | 🐛 84 | 🌐 Erlang | 📅 2026-03-24 - 一个release发布工具.

### web框架

*web开发框架*

* [cowboy](https://github.com/ninenines/cowboy) ⭐ 7,521 | 🐛 67 | 🌐 Erlang | 📅 2026-09-16 - 一个小巧，高效的HTTP服务器.
...
* [Zotonic](https://github.com/zotonic/zotonic) ⭐ 847 | 🐛 195 | 🌐 Erlang | 📅 2026-09-24 - 高效,实时的web框架并且包括内容管理系统.

### HTTP

*HTTP相关的库*

* [hackney](https://github.com/benoitc/hackney) ⭐ 1,417 | 🐛 14 | 🌐 Erlang | 📅 2026-09-24 - 一个小巧的Erlang HTTP客户端.
...
* [rebar3](https://github.com/rebar/rebar3) ⭐ 1,819 | 🐛 226 | 🌐 Erlang | 📅 2026-09-22 - 可以管理来自[Hex.pm](https://hex.pm/)的包. 更多查看 [rebar3.org](https://www.rebar3.org/)
* [rebar](https://github.com/rebar/rebar) ⚠️ Archived - Erlang的构建工具,使用它可以方便的编译、测试erlang程序、内联驱动和打包Erlang发行版本.
* [erlang.mk](https://github.com/ninenines/erlang.mk) ⭐ 587 | 🐛 27 | 🌐 Makefile | 📅 2026-09-24 - erlang的makefile.
...
* [emqtt](https://github.com/emqtt/emqttd) ⭐ 16,755 | 🐛 239 | 🌐 Erlang | 📅 2026-09-24 - 百万级分布式开源物联网MQTT消息服务器
* [rabbitmq](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,875 | 🐛 266 | 🌐 JavaScript | 📅 2026-09-25 - 支持多种协议AMQP, STOMP, MQTT, AMQP的消息代理服务器
* [ejabberd](https://github.com/processone/ejabberd) ⭐ 6,733 | 🐛 226 | 🌐 Erlang | 📅 2026-09-24 - 著名的XMPP服务器
* [vernemq](https://github.com/erlio/vernemq) ⭐ 3,637 | 🐛 172 | 🌐 Erlang | 📅 2026-09-17 - 基于Erlang/OTP的分布式MQTT消息服务器
* [MongooseIM](https://github.com/esl/MongooseIM) ⭐ 1,760 | 🐛 37 | 🌐 Erlang | 📅 2026-09-24 - 高效的分布式XMPP服务器,ejabberd的优化版本

## 开发工具

*开发工具*

* [intellij-erlang](https://github.com/ignatov/intellij-erlang) ⭐ 752 | 🐛 274 | 🌐 Java | 📅 2026-09-17 - intellij插件.
...
* [theBeamBook](https://github.com/happi/theBeamBook) ⭐ 4,056 | 🐛 1 | 🌐 Erlang | 📅 2026-09-24 - A description of the Erlang Runtime System ERTS and the virtual Machine BEAM.
