...
* [cowboy](https://github.com/ninenines/cowboy) ⭐ 7,523 | 🐛 65 | 🌐 Erlang | 📅 2026-09-16 - 一个小巧，高效的HTTP服务器.
...
* [erlang.mk](https://github.com/ninenines/erlang.mk) ⭐ 587 | 🐛 41 | 🌐 Makefile | 📅 2026-09-16 - erlang的makefile.
...
* [emqtt](https://github.com/emqtt/emqttd) ⭐ 16,729 | 🐛 197 | 🌐 Erlang | 📅 2026-09-17 - 百万级分布式开源物联网MQTT消息服务器
* [rabbitmq](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,851 | 🐛 262 | 🌐 JavaScript | 📅 2026-09-16 - 支持多种协议AMQP, STOMP, MQTT, AMQP的消息代理服务器
* [ejabberd](https://github.com/processone/ejabberd) ⭐ 6,725 | 🐛 226 | 🌐 Erlang | 📅 2026-09-16 - 著名的XMPP服务器
* [vernemq](https://github.com/erlio/vernemq) ⭐ 3,632 | 🐛 174 | 🌐 Erlang | 📅 2026-09-04 - 基于Erlang/OTP的分布式MQTT消息服务器
* [MongooseIM](https://github.com/esl/MongooseIM) ⭐ 1,756 | 🐛 35 | 🌐 Erlang | 📅 2026-09-16 - 高效的分布式XMPP服务器,ejabberd的优化版本

## 开发工具

*开发工具*

* [intellij-erlang](https://github.com/ignatov/intellij-erlang) ⭐ 752 | 🐛 273 | 🌐 Java | 📅 2026-09-16 - intellij插件.
