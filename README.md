...
* [cowboy](https://github.com/ninenines/cowboy) ⭐ 7,525 | 🐛 64 | 🌐 Erlang | 📅 2026-08-25 - 一个小巧，高效的HTTP服务器.
...
* [rebar3](https://github.com/rebar/rebar3) ⭐ 1,818 | 🐛 227 | 🌐 Erlang | 📅 2026-08-24 - 可以管理来自[Hex.pm](https://hex.pm/)的包. 更多查看 [rebar3.org](https://www.rebar3.org/)
...
* [emqtt](https://github.com/emqtt/emqttd) ⭐ 16,666 | 🐛 171 | 🌐 Erlang | 📅 2026-08-28 - 百万级分布式开源物联网MQTT消息服务器
* [rabbitmq](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,820 | 🐛 261 | 🌐 JavaScript | 📅 2026-08-28 - 支持多种协议AMQP, STOMP, MQTT, AMQP的消息代理服务器
* [ejabberd](https://github.com/processone/ejabberd) ⭐ 6,721 | 🐛 222 | 🌐 Erlang | 📅 2026-08-27 - 著名的XMPP服务器
* [vernemq](https://github.com/erlio/vernemq) ⭐ 3,626 | 🐛 164 | 🌐 Erlang | 📅 2026-08-27 - 基于Erlang/OTP的分布式MQTT消息服务器
* [MongooseIM](https://github.com/esl/MongooseIM) ⭐ 1,751 | 🐛 31 | 🌐 Erlang | 📅 2026-08-28 - 高效的分布式XMPP服务器,ejabberd的优化版本
...
* [theBeamBook](https://github.com/happi/theBeamBook) ⭐ 4,050 | 🐛 1 | 🌐 Erlang | 📅 2026-04-26 - A description of the Erlang Runtime System ERTS and the virtual Machine BEAM.
* [tsung](https://github.com/processone/tsung) ⭐ 2,629 | 🐛 130 | 🌐 Erlang | 📅 2026-03-02 - 支持HTTP, XMPP, LDAP,等多种协议的压力测试工具.
* [kerl](https://github.com/kerl/kerl) ⭐ 1,664 | 🐛 18 | 🌐 Shell | 📅 2025-06-19 - Erlang安装工具，能够轻松切换多个版本.
