...
* [Zotonic](https://github.com/zotonic/zotonic) ⭐ 847 | 🐛 198 | 🌐 Erlang | 📅 2026-09-10 - 高效,实时的web框架并且包括内容管理系统.
...
* [rebar3](https://github.com/rebar/rebar3) ⭐ 1,818 | 🐛 227 | 🌐 Erlang | 📅 2026-09-10 - 可以管理来自[Hex.pm](https://hex.pm/)的包. 更多查看 [rebar3.org](https://www.rebar3.org/)
...
* [emqtt](https://github.com/emqtt/emqttd) ⭐ 16,705 | 🐛 187 | 🌐 Erlang | 📅 2026-09-10 - 百万级分布式开源物联网MQTT消息服务器
* [rabbitmq](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,849 | 🐛 261 | 🌐 JavaScript | 📅 2026-09-11 - 支持多种协议AMQP, STOMP, MQTT, AMQP的消息代理服务器
...
* [MongooseIM](https://github.com/esl/MongooseIM) ⭐ 1,753 | 🐛 35 | 🌐 Erlang | 📅 2026-09-10 - 高效的分布式XMPP服务器,ejabberd的优化版本
...
* [theBeamBook](https://github.com/happi/theBeamBook) ⭐ 4,052 | 🐛 1 | 🌐 Erlang | 📅 2026-09-05 - A description of the Erlang Runtime System ERTS and the virtual Machine BEAM.
